...
Namespace Contensive.Addons.AddonManager51
    ...
    Public Class CollectionLibraryClass
        ...
        End Structure
        '
        Private ReadOnly CollectionCnt As Integer
        Private ReadOnly Collections() As Collection2Type
            ...
            Try
                ...
                Else
                    ...
                    If (Button = ButtonOK) Then
                        ...
                        If Not String.IsNullOrEmpty(cp.Doc.GetText("LibraryRow")) Then
                        ...
                        End If
                        '
                        If Not String.IsNullOrEmpty(InstallLibCollectionList) Then
                                ...
                                Select Case LCase(CDef_Node.Name)
                                    Case "collection"
                                        ...
                                        For Each CollectionNode In CDef_Node.ChildNodes
                                            ...
                                            End Select
                                        Next
                                        If String.IsNullOrEmpty(CollectionImageLink) Then
                                            CollectionImageLink = "/addonManager/libraryNoImage.jpg"
                                        End If
                                        If String.IsNullOrEmpty(CollectionModifiedDateCaption) Then
                                            CollectionModifiedDateCaption = "unknown"
                                        End If
                                        If String.IsNullOrEmpty(CollectionDescription) Then
                                        ...
                                        If Not String.IsNullOrEmpty(CollectionName) Then
                                            If Not String.IsNullOrEmpty(CollectionGUID) Then

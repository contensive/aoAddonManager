...
Namespace Contensive.Addons.AddonManager.Models
    Public Class ContentModel
        ...
        ''' <returns></returns>
        Public Shared Function createListFromCollection(cp As CPBaseClass, collectionId As Integer) As List(Of ContentModel)
            Return createList(cp, "id in (select distinct contentId from ccAddonCollectionCDefRules where collectionid=" & collectionId & ")", "name")
        End Function
    End Class
End Namespace
